...
import { CustomerRegisterSchema } from "@/src/features/customer/schema/customer.schema";
import { ICustomerRegisterTypes } from "@/src/features/customer/types/customer.types";
...
export default function CustomerRegister() {
  ...
  const onSubmit: SubmitHandler<ICustomerRegisterTypes> = async (data) => {
    try {
      setError("");
      setSuccess("");
